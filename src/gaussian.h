...
public:
    ...
    void initializeCoarseToFine(const std::shared_ptr<Dataset>& dataset);
...
double optimize(const std::shared_ptr<Dataset>& dataset, std::shared_ptr<GaussianModel>& pc, int iteration = 0);
